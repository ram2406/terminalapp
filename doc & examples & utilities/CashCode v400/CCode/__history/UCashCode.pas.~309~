...
//Коды информавционных сообщений диапазон от 200 до 299
//201 - опрос
//202 - NSC
//203 - ASC
//204 - сброс
  ...
  begin
    ...
    begin
      ...
      case FirsByte of
        ...
        $80:begin
              ProcessMessage(245,'Депонет'); // Дорабатывать не стал, так как не вижу практического применения, в общем кому надо тот допилит
            end;
        $81:begin
              ...
              PolingBill(BillNominal,FCanPollingLoop);  // Дадим сообщение о принятой купюре
              if result>=Sum then
              begin
